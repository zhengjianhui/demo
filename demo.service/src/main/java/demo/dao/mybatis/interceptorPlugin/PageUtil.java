...
import demo.dao.mybatis.interceptorPlugin.page.PageSize;
...
public class PageUtil {
     ...
     * @return
     */
    public static String appendSql(String sql, PageRequest page) {
        ...
        if(page.getSqrt() !=null) {
            sb.append(" ").append("order by").append(" ").append("index").append(" ").append(page.getSqrt());
        }
